...
const Section_4 = () => {
  return (
    <div className=" my-10 md:h-[600px] bg-[url(https://i.ibb.co.com/RS8LnYY/featured.jpg)] bg-center bg-cover bg-no-repeat">
        ...
        <div className=" container mx-auto px-5 text-white">
          ...
          <div className=" flex gap-5 max-md:flex-col md:h-[300px]">
            <div className=" w-full">
                <img src="https://i.ibb.co.com/RS8LnYY/featured.jpg" alt="food" className=" w-full h-full object-cover" />
            </div>
            <div className=" w-full flex flex-col items-center justify-center">
              ...
              <button className=" mt-5 px-5 py-3 rounded-lg border-b-4 border-white hover:scale-105 active:scale-100">READ MORE</button>
            </div>
          </div>
        </div>
      </div>
